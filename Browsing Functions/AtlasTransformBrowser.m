...
ud.currentProbe = 0; 
ud.ProbeColors = .75*[1.3 1.3 1.3; 1 .75 0;  .3 1 1; .4 .6 .2; 1 .35 .65; .7 .7 .9; .65 .4 .25; .7 .95 .3; .7 0 0; .6 0 .7; 1 .6 0]; 
ud.ProbeColors = [ud.ProbeColors; distinguishable_colors(9,ud.ProbeColors)];
ud.ProbeColor =  {'white','gold','turquoise','fern','bubble gum','overcast sky','rawhide','green apple','purple','orange','red', 'ex1','ex2','ex3','ex4','ex5','ex6','ex7','ex8','ex9'};
